...
export const testData = {
    ...
    succesLogin: 'https://automationteststore.com/index.php?rt=account/success',
    logoutPageUrl: 'https://automationteststore.com/index.php?rt=account/logout',
    accountPageUrl: 'https://automationteststore.com/index.php?rt=account/account'
};